...
def write_summary(adata: ad.AnnData) -> None:
    ...
    lines.extend([
        ...
        "  1. Ten transcriptionally distinct cancer epithelial subclusters (~26.5%",
        "     of cells) express KRT19 (log2fc=7.1), ELF3 (6.7), CLDN4 (6.4),",
        "     KRT18 (6.3), CD24 (5.9), and KRT8 (5.8) vs. all other cell types.",
        "     Cancer_Epithelial_10 expresses AZGP1/AGR2/AGR3 — an ER+ luminal",
        "     signature consistent with hormone receptor-positive disease.",
        "  2. Cancer cells downregulate MHC-I components HLA-B (log2fc=−3.2) and",
        "     B2M (−2.8) relative to non-cancer cells, suggesting immune evasion",
        "     via antigen presentation loss.",
        "  3. T cells are the dominant immune population (~29.1% combined across",
        "     three subclusters). T_cells_3 co-expresses CXCR4 and MALAT1,",
        "     consistent with a tissue-homing or exhausted phenotype. PD-1",
        "     (PDCD1) and PD-L1 (CD274) expression indicates active immune",
        "     checkpoint signalling in the TME.",
        "  4. Myeloid and innate compartment: macrophages (9.4%), NK cells (6.1%,",
        "     NKG7+), and mast cells (1.1%) contribute to innate immune activity.",
        "  5. Active humoral immunity: plasmablasts (~3.7%) and B cells (3.5%)",
        "     together represent ~7.2% of TME; MS4A1/CD20 (log2fc=8.7) is the",
        "     top B-cell marker.",
        "  6. Stromal compartment: three fibroblast subclusters (~12.9%, COL1A1/",
        "     FAP/ACTA2+ CAFs) and endothelial cells (7.6%, PECAM1+/VWF+)",
        "     indicate an activated, pro-tumorigenic stroma with active angiogenesis.",
        "  7. Molecular subtype analysis (ER+, HER2+, TNBC) reveals distinct",
        "     transcriptional programmes; ER+ tumours are enriched for AZGP1,",
        "     AGR2, AGR3, ANKRD30A, and XIST.",
        "  8. Findings align with published breast cancer scRNA-seq atlases",
